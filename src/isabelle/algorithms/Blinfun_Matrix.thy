theory Blinfun_Matrix
  imports 
    "MDP-Rewards-local.Blinfun_Util" 
    Matrix_Util
begin
...
lemma nonneg_blinfun_iff: "nonneg_blinfun X \<longleftrightarrow> (0 \<le> blinfun_to_matrix X)"
proof
  show "nonneg_blinfun X \<Longrightarrow> 0 \<le> blinfun_to_matrix X"
  unfolding nonneg_blinfun_def nonneg_mat_iff[of "blinfun_to_matrix X"] 
  by (auto simp add: bfun.Bfun_inverse blinfun_to_matrix_mult'' less_eq_bfun_def less_eq_vec_def)
  show "0 \<le> blinfun_to_matrix X \<Longrightarrow> nonneg_blinfun X"
    unfolding nonneg_blinfun_def nonneg_mat_iff[of "blinfun_to_matrix X"] 
    by (auto simp:  less_eq_bfun_def less_eq_vec_def  blinfun_to_matrix_mult[symmetric])
qed
